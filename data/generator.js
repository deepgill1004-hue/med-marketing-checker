...
window.GENERATOR = {
  ...
  topic_alias: {
    ...
    "外泌體": "（外泌體注射劑型未經衛福部核准、再生醫療法 2026/1/1 上路後嚴管，廣告與療效宣稱違法）",
    "幹細胞": "（幹細胞療程須經主管機關核准，廣告嚴格受限）",
    "美白針": "（注射型美白製劑目前未核准，可改寫口服／外用保養與防曬）",
    "彈力針": "（彈力針＝麗珠蘭 Rejuran／PN 多核苷酸注射劑型，台灣未取得衛福部認證、僅 Booster 水光化妝品可合法塗抹；建議改用核准療程如 PRP 注射、水光針、PLLA 聚左旋乳酸）",
    "麗珠蘭": "（同彈力針，注射劑型未取得台灣衛福部認證）",
    "Rejuran": "（同彈力針，注射劑型未取得台灣衛福部認證）",
    "PN 多核苷酸": "（注射劑型未取得台灣衛福部認證，建議改用 PRP 或 PLLA 等核准療程）",
    "瘦瘦針": "（GLP-1 處方藥廣告投放一般媒體屬違法，需由醫師處方並符合處方藥廣告管理規範）",
  },
